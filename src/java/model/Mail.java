...
public class Mail {
    ...
    private static final String APP_EMAIL = "wkapraveen@gmail.com";
    private static final String APP_PASSWORD = "dgniqfwxuvvesrwy";//here we need to add generated app password
